    ...
    if (success) {
        if (operation === 'login') {
            ...
            if (data.requiresVerification) {
                showSecureMessage('Account created successfully! Please check your email to verify your account before using all features.', 'success');
            } else {
                showSecureMessage('Account created successfully! Email verification is disabled in development mode.', 'success');
            }
